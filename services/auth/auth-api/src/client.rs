...
#[derive(Clone)]
pub struct AuthApiClient(AuthServiceClient<TracingServiceClient<Channel>>);
...
#[rustfmt::skip]
#[async_trait]
pub trait IAuthApiClient: Send + Sync + 'static {
...
#[rustfmt::skip]
#[async_trait]
impl IAuthApiClient for AuthApiClient {
    async fn create_session(&self, req: Request<CreateSessionReq>) -> Result<Response<CreateSessionResp>, Status> {
...
pub mod testutils {
    ...
    #[rustfmt::skip]
    #[async_trait]
    impl IAuthApiClient for MockAuthApiClient {
        async fn create_session(&self, req: Request<CreateSessionReq>) -> Result<Response<CreateSessionResp>, Status> {
