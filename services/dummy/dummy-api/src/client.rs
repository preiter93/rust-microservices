...
#[derive(Clone)]
pub struct DummyApiClient(DummyServiceClient<TracingServiceClient<Channel>>);
...
#[rustfmt::skip]
#[async_trait]
pub trait IDummyApiClient: Send + Sync + 'static {
...
#[rustfmt::skip]
#[async_trait]
impl IDummyApiClient for DummyApiClient {
    async fn create_entity(&self, req: Request<CreateEntityReq>) -> Result<Response<CreateEntityResp>, Status> {
...
pub mod testutils {
    ...
    impl Default for MockDummyApiClient {
        fn default() -> Self {
            Self {
    ...
    #[rustfmt::skip]
    #[async_trait]
    impl IDummyApiClient for MockDummyApiClient {
        async fn create_entity(&self, req: Request<CreateEntityReq>) -> Result<Response<CreateEntityResp>, Status> {
